...
class OutfitDataService {
    ...
    wipeAllOutfits() {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b, _c;
            debugLog('Starting wipeAllOutfits process', null, 'info', 'OutfitDataService');
            try {
                // Log initial state before wiping
                const initialStoreState = outfitStore.getState();
                debugLog('Initial store state:', {
                    ...
                    userInstancesCount: initialStoreState.userInstances
                        ...
                        : 0,
                    botPresetsCount: initialStoreState.presets && initialStoreState.presets.bot
                        ? Object.keys(initialStoreState.presets.bot).length
                        : 0,
                    userPresetsCount: initialStoreState.presets && initialStoreState.presets.user
                        ? Object.keys(initialStoreState.presets.user).length
                        : 0,
                }, 'log', 'OutfitDataService');
                const initialDataManagerState = this.dataManager.load();
                debugLog('Initial data manager state:', {
                ...
                debugLog('Clearing store in memory', null, 'info', 'OutfitDataService');
                outfitStore.wipeAllOutfitData();
                // Verify the store has been cleared
                const storeAfterWipe = outfitStore.getState();
                debugLog('Store state after wiping in memory:', {
                ...
                debugLog('Saving wiped data to data manager using direct wipe method', null, 'info', 'OutfitDataService');
                ...
                debugLog('Data manager state after direct saveOutfitData:', {
                ...
                debugLog('Loading wiped data from data manager to store', null, 'info', 'OutfitDataService');
                ...
                debugLog('Store state after loading from data manager:', {
                    ...
                    userInstancesCount: storeAfterLoadState.userInstances
                        ...
                        : 0,
                    botPresetsCount: storeAfterLoadState.presets && storeAfterLoadState.presets.bot
                        ? Object.keys(storeAfterLoadState.presets.bot).length
                        : 0,
                    userPresetsCount: storeAfterLoadState.presets && storeAfterLoadState.presets.user
                ...
                if (STContext) {
                    ...
                    debugLog('Attempting immediate save with completely empty data:', {
                    ...
                    if (STContext.extensionSettings) {
                        debugLog('Saving to extensionSettings', null, 'info', 'OutfitDataService');
                        ...
                        if (this.dataManager.storageService && this.dataManager.storageService.saveFn) {
                            debugLog('Using fallback direct save', null, 'info', 'OutfitDataService');
                ...
                debugLog('Loading wiped data from data manager to store after save', null, 'info', 'OutfitDataService');
                ...
                debugLog('All outfit data wiped successfully', null, 'info', 'OutfitDataService');
